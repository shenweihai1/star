...
./bench_ycsb --logtostderr=1 --id=0 --servers="10.1.0.7:8000" --protocol=Calvin --partition_num=$trd --threads=$trd --batch_size=10000 --replica_group=1 --lock_manager=$lock --read_write_ratio=50 --cross_ratio=0 > ./xxxx14/$trd.log 2>&1
